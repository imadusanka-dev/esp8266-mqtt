...
const char* ssid = "I madushanka";
const char* password = "I$vru1234";

/******* MQTT Broker Connection Details *******/
const char* mqtt_server = "484d83c4914a41068ef32d335ab58f9c.s1.eu.hivemq.cloud";
const char* mqtt_username = "user1";
const char* mqtt_password = "User1234";
